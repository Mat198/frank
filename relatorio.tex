...
Redes neurais profundas podem fornecer estimativas de forma e pose, facilitando a identificação e caracterização de objetos e métodos de aprendizagem por reforço possibilitam que robôs adquiram habilidades diretamente por interação, aprendendo a lidar com fenômenos que podem não ser bem modelados pelos métodos tradicionais. Embora ainda existam desafios de eficiência e estabilidade, a combinação de princípios clássicos com componentes aprendidos tem se mostrado uma boa estratégia para aumentar a autonomia, adaptabilidade e generalização dos manipuladores.
